...
function ManageAnimals({ animalData, setAnimalData, addAnimal, animalId, setAnimalId,showSidebar }) {
  ...
  useEffect(() => {
    const fetchManageAnimals = async () => {
      try {
        const response = await fetch('https://coogzootestbackend-phi.vercel.app/animals');
        if (!response.ok) {
  ...
  const updateAnimal = async () => {
    ...
    try {
      const response = await fetch(`https://coogzootestbackend-phi.vercel.app/update-animal?id=${updateData.id}`, {
        method: 'PUT',
  ...
  const handleDeleteAnimal = async () => {
    try {
      const response = await fetch(`https://coogzootestbackend-phi.vercel.app/remove-animal?id=${animalId}`, {
        method: 'DELETE',
      });
